document.querySelector('.purchaseBookButton').addEventListener('click', function(event) {
    ...
    if (newPrice > currentPrice) {
        ...
        window.location.href = '../html/subscriptiondis.html';
...
//     if (!accessibleGenres.includes(genre)) {
...
//             window.location.href = '../html/upgradeplan.html'; // Redirect to upgrade page for Gold
//         } else if (genre === 'Biography' && subscription === 'Gold') {
//             alert('You need to upgrade to Platinum to access Biography books.');
//             window.location.href = '../html/upgradeplan.html'; // Redirect to upgrade page for Platinum
...
// document.querySelectorAll('.rentButton, .purchaseButton').forEach(button => {
//     button.addEventListener('click', function() {
//         const actionType = button.classList.contains('rentButton') ? 'rent' : 'purchase';
...
//         alert(`You need to subscribe to a higher plan to access ${genre} books.`);
//         // window.location.href = '../html/subscription.html'; // Redirect to subscription page
//         return
...
//         if (genre === 'Non-Fiction' && subscription === 'Silver') {
//             alert('You need to upgrade to Gold to access Non-Fiction books.');
//             window.location.href = '../html/upgrade.html'; // Redirect to upgrade page for Gold
//         } else if (genre === 'Biography' && subscription === 'Gold') {
//             alert('You need to upgrade to Platinum to access Biography books.');
//             window.location.href = '../html/upgrade.html'; // Redirect to upgrade page for Platinum
//         } else if (genre === 'Studies' && subscription === 'Platinum') {
//             alert('You need to upgrade to Platinum to access Studies books.');
//             window.location.href = '../html/upgrade.html'; // Redirect to upgrade page for Platinum
//         } else {
